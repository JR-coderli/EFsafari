...
###############################################################################
#bash使用说明！#
#  chmod +x run_month_etl.sh
# nohup ./run_month_etl.sh > etl_log.txt 2>&1 &
#  日期范围运行（如整个1月）：
#  nohup ./run_month_etl.sh -s 2026-01-01 -e 2026-01-31 > etl_log_0116.txt 2>&1 &

#  带间隔时间运行（避免服务器压力）：
#  nohup ./run_month_etl.sh -s 2026-01-01 -e 2026-01-31 --sleep 5 > etl_log.txt 2>&1 &

#  查看进度：
#  tail -f etl_log.txt

#  查看进程：
#  ps aux | grep run_month_etl
# ==================== 配置区域 ====================
